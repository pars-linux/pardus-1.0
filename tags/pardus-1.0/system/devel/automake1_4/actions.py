...
WorkDir = "automake-1.4-p6"

def setup():
    pisitools.dosed("tests/Makefile.in", "error\.test")
    pisitools.dosed("automake.texi", "(?m)^(@setfilename.*)automake", r"\1automake1.4")
    pisitools.dosed("automake.texi", "automake: (automake)", "automake v1.4: (automake1.4)")
    pisitools.dosed("automake.texi", "aclocal: (automake)", "aclocal v1.4: (automake1.4)")
