...
" aspperl language
let s:tlist_def_aspperl_settings = 'asp;f:fonksiyon;s:sub;v:değişken'

" aspvbs language
let s:tlist_def_aspvbs_settings = 'asp;f:fonksiyon;s:sub;v:değişken'

" awk language
let s:tlist_def_awk_settings = 'awk;f:fonksiyon'

" beta language
let s:tlist_def_beta_settings = 'beta;f:fragment;s:slot;v:pattern'

" c language
let s:tlist_def_c_settings = 'c;d:makro;g:enum;s:veriyapısı;u:union;t:typedef;' .
                           \ 'v:değişken;f:fonksiyon'

" c++ language
let s:tlist_def_cpp_settings = 'c++;v:değişken;d:macro;t:typedef;c:sınıf;' .
                             \ 'n:namespace;g:enum;s:veriyapısı;u:union;f:fonksiyon'

" c# language
let s:tlist_def_cs_settings = 'c#;d:macro;t:typedef;n:namespace;c:sınıf;' .
...
" eiffel language
let s:tlist_def_eiffel_settings = 'eiffel;c:sınıf;f:feature'

" erlang language
let s:tlist_def_erlang_settings = 'erlang;d:makro;r:record;m:module;f:fonksiyon'

" expect (same as tcl) language
let s:tlist_def_expect_settings = 'tcl;c:sınıf;f:method;p:prosedür'

" fortran language
let s:tlist_def_fortran_settings = 'fortran;p:program;b:block data;' .
                    \ 'c:common;e:entry;i:interface;k:type;l:label;m:module;' .
                    \ 'n:namelist;t:derived;v:değişken;f:fonksiyon;s:subroutine'

" HTML language
let s:tlist_def_html_settings = 'html;a:link;f:javascript fonksiyonu'

" java language
let s:tlist_def_java_settings = 'java;p:paket;c:sınıf;i:interface;' .
                              \ 'f:field;m:method'

" javascript language
let s:tlist_def_javascript_settings = 'javascript;f:fonksiyon'

" lisp language
let s:tlist_def_lisp_settings = 'lisp;f:fonksiyon'

" lua language
let s:tlist_def_lua_settings = 'lua;f:fonksiyon'

" makefiles
let s:tlist_def_make_settings = 'make;m:macro'

" pascal language
let s:tlist_def_pascal_settings = 'pascal;f:fonksiyon;p:prosedür'

" perl language
let s:tlist_def_perl_settings = 'perl;c:sabit;l:label;p:paket;s:subroutine'

" php language
let s:tlist_def_php_settings = 'php;c:sınıf;d:sabit;v:değişken;f:fonksiyon'

" python language
let s:tlist_def_python_settings = 'python;c:sınıf;m:metot;f:fonksiyon'

" rexx language
let s:tlist_def_rexx_settings = 'rexx;s:subroutine'

" ruby language
let s:tlist_def_ruby_settings = 'ruby;c:sınıf;f:method;F:fonksiyon;' .
                              \ 'm:singleton method'

" scheme language
let s:tlist_def_scheme_settings = 'scheme;s:set;f:fonksiyon'

" shell language
let s:tlist_def_sh_settings = 'sh;f:fonksiyon'

" C shell language
let s:tlist_def_csh_settings = 'sh;f:fonksiyon'

" Z shell language
let s:tlist_def_zsh_settings = 'sh;f:fonksiyon'

" slang language
let s:tlist_def_slang_settings = 'slang;n:namespace;f:fonksiyon'

" sml language
let s:tlist_def_sml_settings = 'sml;e:exception;c:functor;s:signature;' .
                             \ 'r:structure;t:type;v:value;f:fonksiyon'

" sql language
let s:tlist_def_sql_settings = 'sql;c:cursor;F:field;P:paket;r:record;' .
            \ 's:subtype;t:table;T:trigger;v:değişken;f:fonksiyon;p:prosedür'

" tcl language
let s:tlist_def_tcl_settings = 'tcl;c:sınıf;f:method;m:method;p:prosedür'

" vera language
let s:tlist_def_vera_settings = 'vera;c:sınıf;d:macro;e:enumerator;' .
                                \ 'f:fonksiyon;g:enum;m:metot;p:program;' .
                                \ 'P:prototype;t:task;T:typedef;v:değişken;' .
                                \ 'x:externvar'

"verilog language
let s:tlist_def_verilog_settings = 'verilog;m:module;c:sabit;P:parameter;' .
            \ 'e:event;r:register;t:task;w:write;p:port;v:değişken;f:fonksiyon'

" vim language
let s:tlist_def_vim_settings = 'vim;a:autocmds;v:değişken;f:fonksiyon'
...
function! s:Tlist_Display_Help()
    ...
    if s:tlist_brief_help
        " Add the brief help
        call append(0, '" Etiketler (yardım: ?)')
    else
        " Add the extensive help
        call append(0, '" <enter> : Etiket tanımına git')
        call append(1, '" o : Etiket tanımına yeni pencerede git')
        call append(2, '" p : Etiket tanımını önizle')
        call append(3, '" <space> : Etiketin prototopini göster')
        call append(4, '" u : Etiket listesini güncelle')
        call append(5, '" s : Sıralama düzenini değiştir')
        call append(6, '" d : Dosyayı etiket listesinden çıkar')
        call append(7, '" x : Etiket penceresini büyüt/küçült')
        call append(8, '" + : Klasör (fold) aç')
        call append(9, '" - : Klasör kapat')
        call append(10, '" * : Tüm klasörleri aç')
        call append(11, '" = : Tüm klasörleri kapat')
        call append(12, '" [[ : Önceki dosyanın başlangıcına git')
        call append(13, '" ]] : Sonraki dosyanın başlangıcına git')
        call append(14, '" q : Etiket penceresini kapat')
        call append(15, '" ? : Yardım metnini kapat')
    endif
endfunction
